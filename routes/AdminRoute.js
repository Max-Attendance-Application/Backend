...
import { createAdminRecord, getAllAdminRecords, getAdminRecordsByDateRange, getStatistics } from '../controllers/Admin.js';
...
router.get('/statistics', verifyUser, adminOnly, getStatistics);
